...
export abstract class PreloadSceneBase extends Phaser.Scene {
  ...
  init(): void {
    ...
    // Reset flags (Phaser reutiliza la instancia en scene.restart/start)
  ...
  create(): void {
    ...
    // Configurar evento de carga completa (ONCE para evitar re-disparo si se usa el loader después)
